package scooterthecat.restaurantvote.user;
...
import static scooterthecat.restaurantvote.user.ProfileController.REST_URL;
import static scooterthecat.restaurantvote.user.UserTestData.*;
